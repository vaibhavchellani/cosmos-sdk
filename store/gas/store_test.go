...
func newGasTank(limit sdk.Gas) *sdk.GasTank {
	return sdk.NewGasTank(sdk.NewGasMeter(limit), sdk.DefaultGasConfig())
}
...
func TestGasKVStoreBasic(t *testing.T) {
	...
	require.Empty(t, st.Get(utils.KeyFmt(1)), "Expected `key1` to be empty")
	require.Equal(t, tank.GasConsumed(), sdk.Gas(183))
}
...
func TestGasKVStoreIterator(t *testing.T) {
	...
	require.Equal(t, tank.GasConsumed(), sdk.Gas(356))
}
